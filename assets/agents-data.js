...
window.BN_AGENTS = [
  {
    ...
    connectorIds: ["bnc:connector:kvk-handelsregister", "bnc:connector:ubo-register", "bnc:connector:eu-sanctielijsten", "bnc:connector:vies-btw-validatie"],
  ...
  },
  {
    ...
    connectorIds: ["bnc:connector:kvk-handelsregister", "bnc:connector:bkr-toetsing", "bnc:connector:creditsafe-bedrijfskrediet"],
  ...
  },
  {
    ...
    connectorIds: ["bnc:connector:generic-rest", "bnc:connector:euronext-marktdata"],
  ...
  },
  {
    ...
    connectorIds: ["bnc:connector:exact-online", "bnc:connector:postnl-verzendservice"],
  ...
  },
  {
    ...
    connectorIds: ["bnc:connector:ocpi-laadinfra", "bnc:connector:generic-rest", "bnc:connector:rdw-voertuigen"],
  ...
  },
  {
    ...
    connectorIds: ["bnc:connector:generic-rest", "bnc:connector:duo-diplomaregister", "bnc:connector:justis-vog"],
  ...
  },
  {
    ...
    connectorIds: ["bnc:connector:digid", "bnc:connector:eherkenning", "bnc:connector:kvk-handelsregister", "bnc:connector:kadaster-bag"],
    certification: { books: ["II"], status: "in certificering", validUntil: null },
    annexIII: true,
    riskFactor: 63,
  ...
  },
  {
    ...
    connectorIds: ["bnc:connector:ms-graph", "bnc:connector:validsign"],
  ...
  },
  {
    ...
    connectorIds: ["bnc:connector:idin", "bnc:connector:salesforce", "bnc:connector:sivi-afs-polisdata"],
    certification: { books: ["II", "VI"], status: "gecertificeerd", validUntil: "2027-05" },
    annexIII: false,
    riskFactor: 52,
  ...
  },
  {
    ...
    connectorIds: ["bnc:connector:nmbrs-payroll", "bnc:connector:visma-raet-hr"],
    certification: { books: [], status: "aangemeld", validUntil: null },
    annexIII: true,
    riskFactor: 79,
  ...
  },
  {
    ...
    connectorIds: ["bnc:connector:kvk-handelsregister", "bnc:connector:generic-rest", "bnc:connector:woz-waardeloket", "bnc:connector:kadaster-bag"],
  ...
  },
  {
    ...
    connectorIds: ["bnc:connector:exact-online", "bnc:connector:cbs-statline"],
